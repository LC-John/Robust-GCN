...
for epoch in range(FLAGS.epochs):
    ...
    feed_dict = construct_feed_dict(features_dense, support, y_train, train_mask, placeholders)
    ...
    # Validation
    cost, acc, duration = evaluate(features_dense, support, y_val, val_mask, placeholders)
...
save_path = "../model/" + FLAGS.dataset + "_" + FLAGS.model
